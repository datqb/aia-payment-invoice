...
(function() {
    ...
    var PersonalisationStore = function(name, config){
        ContextHub.console.debug(name, config);
        this.init(name, config);
    };

    const STORE_NAME = 'contexthub.personalisation';
    
    ContextHub.Utils.inheritance.inherit(PersonalisationStore, ContextHub.Store.PersistedStore);
    ContextHub.Utils.storeCandidates.registerStoreCandidate(PersonalisationStore, STORE_NAME, 0);
